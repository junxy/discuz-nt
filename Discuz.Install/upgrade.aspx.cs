...
namespace Discuz.Install
{
    public class Upgrade : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                if (Request.QueryString["connection"] == "check")
                    CheckConnection();
            }
        }
        ...
        {
            //if (rblBBSVersion.SelectedIndex <= 0)   //Discuz!NT 2.0升级到Discuz!NT 2.1
            //{

            //}
            //if (rblBBSVersion.SelectedIndex <= 1)   //Discuz!NT 2.1升级到Discuz!NT 2.5
            //{
