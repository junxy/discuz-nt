...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2011/3/22 11:14:47.
		本页面代码由Discuz!NT模板引擎生成于 2011/3/22 11:14:47. 
	*/
	...
	templateBuilder.Append(subforum.Lasttitle.ToString().Trim());
	templateBuilder.Append("\"><span>");	templateBuilder.Append(Convert.ToDateTime(subforum.Lastpost).ToString(" yyyy-MM-dd HH:mm"));
	...
	templateBuilder.Append("\r\n					<a id=\"intervalmenu\" onclick=\"showMenu(this.id);\" href=\"javascript:;\" class=\"drop xg2\">全部主题</a>\r\n				    <ul id=\"intervalmenu_menu\" class=\"p_pop\" style=\"display: none\">\r\n				        <li><a href=\"javascript:selectinterval(0);\">全部主题</a></li>\r\n				        <li><a href=\"javascript:selectinterval(1);\">1 天以来主题</a></li>\r\n				        <li><a href=\"javascript:selectinterval(2);\">2 天以来主题</a></li>\r\n				        <li><a href=\"javascript:selectinterval(7);\">1 周以来主题</a></li>\r\n				        <li><a href=\"javascript:selectinterval(30);\">1 个月以来主题</a></li>\r\n				        <li><a href=\"javascript:selectinterval(90);\">3 个月以来主题</a></li>\r\n				        <li><a href=\"javascript:selectinterval(180);\">6 个月以来主题</a></li>\r\n				        <li><a href=\"javascript:selectinterval(365);\">1 年以来主题</a></li>\r\n				    </ul>\r\n				");
	}	//end if
	...
	templateBuilder.Append("';\r\n			        function loadsearchconditionlink() {\r\n                        var intervalarray = ['1 天以来主题','2 天以来主题','1 周以来主题','1 个月以来主题','3 个月以来主题','6 个月以来主题','1 年以来主题'];\r\n                        if(");
	templateBuilder.Append(interval.ToString());
	templateBuilder.Append("!=0)\r\n                            $('intervalmenu').innerHTML = intervalarray[");
	templateBuilder.Append(interval.ToString());
...
/*特殊帖图标*/
	...
	templateBuilder.Append("/>\r\n			<input type=\"checkbox\" value=\"1\" name=\"parseurloff\" id=\"parseurloff\" ");
	if (parseurloff==1)
	{
	...
	templateBuilder.Append(" />\r\n			<input type=\"checkbox\" value=\"1\" name=\"smileyoff\" id=\"smileyoff\" ");
	if (smileyoff==1)
	{
	...
	templateBuilder.Append(" />\r\n			<input type=\"checkbox\" value=\"1\" name=\"usesig\" id=\"usesig\"");
	if (usesig==1)
	{
	...
	if (postpid>0)
	{
	 ...
	 replyurl = replyurl+"&postid="+postpid+"&postlayer="+postid+"&poster="+Utils.UrlEncode(poster);
	...
	templateBuilder.Append("\">高级编辑器</a>\r\n		");
	}
	else
	{
