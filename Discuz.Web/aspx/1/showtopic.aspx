...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2011/3/22 11:15:01.
		本页面代码由Discuz!NT模板引擎生成于 2011/3/22 11:15:01. 
	*/
	...
	templateBuilder.Append("';\r\n                            }\r\n                            else {\r\n                                window.location = 'showtopic.aspx?topicid=");
	templateBuilder.Append(topicid.ToString());
	...
	templateBuilder.Append("\r\n			    <div class=\"hm\"><span class=\"xg1\">查看:</span> ");
	...
	templateBuilder.Append("\r\n		</td>\r\n		<td class=\"postcontent\">\r\n			<div class=\"pi\">\r\n				<strong>\r\n					<a href=\"###\" class=\"floor\" title=\"复制帖子链接到剪贴板\" onclick=\"setcopy(window.location.toString().replace(/#(.*?)$/ig, '') + '#");
	templateBuilder.Append(post.Pid.ToString().Trim());
	...
	templateBuilder.Append("\r\n				<div class=\"special_reward\">\r\n					<p class=\"reward_price\">悬赏金额: <strong>");
	...
	int postpid = DNTRequest.GetInt("postpid",0);
