...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append(debatepost.Pid.ToString().Trim());
	templateBuilder.Append("');\" id=\"ratelink\" ><i>评分</i></a>\r\n				");
	}	//end if
	...
	templateBuilder.Append("</a>  时间:");	templateBuilder.Append(Convert.ToDateTime(positivepost.Postdatetime).ToString("yyyy-MM-dd HH:mm"));
	...
	templateBuilder.Append("</a>  时间:");	templateBuilder.Append(Convert.ToDateTime(negativepost.Postdatetime).ToString("yyyy-MM-dd HH:mm"));
	templateBuilder.Append("\r\n										</h3>\r\n										<div class=\"debatemessage\" id=\"message");
	templateBuilder.Append(negativepost.Pid.ToString().Trim());
	templateBuilder.Append("\">\r\n										");
