...
override protected void OnInit(EventArgs e)
{
	...
	/* 
		This page was created by Discuz!NT Template Engine at 2011/3/22 11:14:56.
		本页面代码由Discuz!NT模板引擎生成于 2011/3/22 11:14:56. 
	*/
	...
	templateBuilder.Append("\r\n		<!--操作说明开始-->\r\n		<div class=\"topicadminlog\">\r\n		    <h4>\r\n		        <span class=\"hasdropdownbtn y\"><a href=\"javascript:;\" class=\"dropdownbtn\" onclick=\"showselect(this, 'reason', 'reasonselect')\">^</a></span>\r\n		        操作说明:\r\n		    </h4>\r\n		    <p>\r\n			    <textarea onkeyup=\"seditor_ctlent(event, '$(\\'moderateform\\').submit()')\" class=\"txtarea\" name=\"reason\" id=\"reason\" onkeydown=\"if(this.value.length>200){ alert('操作原因不能多于200个字符');return false; }\" ");
	if (operation=="rate")
	{
