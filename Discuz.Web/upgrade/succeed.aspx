	...
	<div class="main s_clear">
		<div class="content">
			...
			<div class="inner">
			    <div class="ad">
			        <ul>
			            <li><a href="http://idc.comsenz.com/store/webwin.php?source=upgrade" target="_blank"><img src="images/ad.jpg" width="500"/ ></a></li>
			        </ul>
			    </div>
			    <div class="msgsinfo">
				    <p>恭喜! 您已经成功升级，为了安全，请及时删除upgrade目录下的aspx文件</p>
		...
		<div class="btn_box"><button type="button" name="go" id="go" onclick="location.href='../'">进入论坛</button></div>
	</div>
</div>
</body>
</html>