...
<div class="wrap">
	...
	<div class="main s_clear">
		<div class="content">
			<h1>欢迎</h1>
			<div class="inner">
				<h1>Discuz!NT 代码使用协议</h1>
<strong>版权所有 (c) 2001-2009，北京康盛新创科技有限责任公司,
  保留所有权利</strong>。 
  <br>
  <br>
...
<p>本授权协议适用且仅适用于 Discuz!NT 3.x 版本，北京康盛新创科技有限责任公司拥有对本授权协议的最终解释权。 <br>
</p>
<p></p><h2>协议许可的权利</h2>
...
<p>电子文本形式的授权协议如同双方书面签署的协议一样，具有完全的和等同的法律效力。您一旦开始安装 Discuz!NT，即被视为完全理解并接受本协议的各项条款，在享有上述条款授予的权力的同时，受到相关的约束和限制。协议许可范围以外的行为，将直接违反本授权协议并构成侵权，我们有权随时终止授权，责令停止损害，并保留追究相关责任的权力。 <br>
  ...
  Discuz!NT官方论坛：<a href="http://nt.discuz.net" target="_blank">http://nt.discuz.net</a><br>
		...
		<div class="btn_box">
		<label for="accept"><input type="checkbox" name="accept" id="accept" />接受</label>
