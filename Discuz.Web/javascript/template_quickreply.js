...
function saveResult(doc, imagedir, redirect){
	...
	html += '			<tbody>';
	html += '			<tr>';
	html += '			<td rowspan="2" class="postauthor" id="' + pid + '">';	
 ...
 */    
	...
	html += '	<img class="avatar" onerror="this.onerror=null;this.src=\'' + imagedir + '/noavatar_medium.gif\';" src="tools/avatar.aspx?uid=' + posterid + '&size=medium" onmouseover="showauthor(this,\'' + posterid + '' + id + '\')" id="memberinfo_' + id + '"/>';
	html += '				</div>';
	if (nickname != ""){
		html += '			<p><em>';
		html += nickname;
