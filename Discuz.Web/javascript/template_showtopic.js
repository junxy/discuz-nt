    ...
    if (showtype == 0) {
        for (var i = 0; i < ratelist.length; i++) {
            ...
            if (nextuid != uid) {
                ...
                html += "<a target='_blank' href='" + avatarurl + "'><img width='48' height='48' onerror='this.onerror=null;this.src=\"" + imagedir + "/noavatar_small.gif\"' ";
...
function loadbuyattach_callback(data) {
    ...
    if (!data[0].haserror) {
        ...
        buyattach_htmll = '<table cellspacing="0" cellpadding="0" summary="购买" style="width:300px;margin:10px;"><tbody>';
