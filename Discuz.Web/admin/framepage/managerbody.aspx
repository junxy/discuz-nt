<%@ Page Language="C#" CodeBehind="managerbody.aspx.cs" Inherits="Discuz.Web.Admin.managerbody" %>
...
<head>
	...
	<script type="text/javascript">
        ...
        function ShortcutMenuContent()
        {
            ...
            shortcutmenustr += '<dd><a href="http://www.discuznt.com/admindoc" target="_blank" onfocus="this.blur();">帮助</a></dd>';
...
<meta http-equiv="X-UA-Compatible" content="IE=7" />
	...
	<div class="NavBody" >
	   <form id="Form1" method="post">
        ...
        <div class="ctrl_title"><a href="javascript:void(0);" onclick="hidemodelbox('setting');"><img src ="../images/close.gif" border="0"/></a><span id="titlebar"></span></div>
