<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="top.aspx.cs" Inherits="Discuz.Web.Admin.top" %>
		...
		<ul id="MainMenu">
		    <li class="MenuDrop">
		        <div class="MenuDropOut" onmouseover="this.className='MenuDropOn'" onmouseout="this.className='MenuDropOut'">
		            <a href="javascript:void(0);" onmouseover="javascript:top.mainFrame.setshorcutmenu('block');" onmouseout="javascript:top.mainFrame.setshorcutmenu('none');" style=" font-size:14px; font-weight:700;">常用功能</a>
		        </div>
		    </li>
		</ul>		
		<div class="SearchBar">
