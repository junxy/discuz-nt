<%@ Page Language="c#" Inherits="Discuz.Web.Admin.forum_attchemnttypes" Codebehind="forum_attchemnttypes.aspx.cs"%>
...
<div id="TabControl1_Tab" class="tabs"><input type="hidden" value="TabControl1:tabPage51" id="TabControl1" name="TabControl1">
	<ul>		
		...
		<li class="TabSelect"><a href="../global/global_ftpsetting.aspx">远程附件</a></li>
