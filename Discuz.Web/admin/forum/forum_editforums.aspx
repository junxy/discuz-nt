<%@ Page language="c#" Inherits="Discuz.Web.Admin.editforums" Codebehind="forum_editforums.aspx.cs" %>
...
<table width="100%">
	...
	<tr>
		...
		<td class="vtop">设置版块URL重写,会以"http://nt.discuz.net/rewritename/"的形式显示,以字母开头,其后可以是字母或数字,但不可包含<br>"install,upgrade,admin,aspx,tools,archive,space"中任意一个字符串</td>
	</tr>
...
<table width="100%">
	...
	<tr>
		...
		<td class="vtop">如果选择"是",用户将可以在本版块中按照不同的类别浏览主题.注意: 本功能必须"启用主题分类"后才可使用并会加重服务器负担</td>
	</tr>
