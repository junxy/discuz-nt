...
<%@ Page language="c#" Inherits="Discuz.Web.Admin.editbbcode" Codebehind="forum_editbbcode.aspx.cs" %>
...
<table width="100%">
	...
	<tr>
		...
		<td class="vtop">标签替换为的 html 代码内容, 支持至多三个动态参数<br />{1} 代表第一个参数<br />{2} 代表第二个参数<br />{3} 代表第三个参数<br />{RANDOM}代表随机生成的字符串</td>
	</tr>
...
<div class="Navbutton">
	...
	<cc1:Button id="DeleteBBCode" runat="server" Text=" 删 除 " ButtonImgUrl="../images/del.gif" OnClientClick="if(!confirm('你确认要删除所选的Discuz!NT代码吗？')) return false;"></cc1:Button>
</div>
</fieldset>
</div>
</form>
