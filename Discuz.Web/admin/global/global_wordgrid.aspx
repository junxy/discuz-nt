<%@ Page Language="c#" Inherits="Discuz.Web.Admin.wordgrid" Codebehind="global_wordgrid.aspx.cs" %>
...
<cc1:TextBox id="antipamreplacement" runat="server" HintShowType="down" CssClass="" RequiredFieldType="暂无校验" TextMode="MultiLine" Height="90px" Rows="4" Cols="50"  HintTitle="提示" HintInfo="屏蔽特殊字符" HintPosOffSet="160"></cc1:TextBox><br /><br />
...
<a href="http://download.comsenz.com/DiscuzNT/doc/badwords.zip">下载官方提供的最新词库文件</a>
