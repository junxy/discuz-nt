<%@ Page Language="c#" Inherits="Discuz.Web.Admin.editorset" CodeBehind="global_editorset.aspx.cs" %>
...
<fieldset>
	<legend style="background: url(../images/icons/legendimg.jpg) no-repeat 6px 50%;">编辑器设置设置</legend>
	<table width="100%">
