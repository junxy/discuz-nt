<%@ Page Language="c#" Inherits="Discuz.Web.Admin.urlgrid" Codebehind="global_urlgrid.aspx.cs" %>
...
<form id="Form1" runat="server">
	...
	<p style="text-align:right;">
		<button type="button" class="ManagerButton" id="Button3" onclick="window.location='global_baseset.aspx';"><img src="../images/arrow_undo.gif"/> 返 回 </button>
	</p>
</form>
<%=footer%>
</body>
