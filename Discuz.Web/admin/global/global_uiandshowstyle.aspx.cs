    ...
    public partial class uiandshowstyle : AdminPage
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                //forumhot.Items[0].Attributes.Add("onclick", "openforumhot(true)");
                //forumhot.Items[1].Attributes.Add("onclick", "openforumhot(false)");
            }
        }
        ...
        public void LoadConfigInfo()
        {
            ...
            //forumhot.SelectedValue = configInfo.Disableforumhot.ToString();
        ...
        private void SaveInfo_Click(object sender, EventArgs e)
        {
            ...
            if (this.CheckCookie())
            {
                ...
                //configInfo.Disableforumhot = TypeConverter.StrToInt(forumhot.SelectedValue);
