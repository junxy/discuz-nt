<%@ Page Language="c#" Inherits="Discuz.Web.Admin.safecontrol" CodeBehind="global_safecontrol.aspx.cs" %>
...
<table width="100%">
	...
	<tr>
		<td class="vtop rowform">
			<cc1:TextBox SetFocusButtonID="SaveInfo" ID="maxonlines" runat="server" RequiredFieldType="数据校验" CanBeNull="必填" Text="9000" MaxLength="5" Size="6" MinimumValue="10" MaximumValue="65535">			</cc1:TextBox>		</td>
		<td class="vtop">请设置合理的数值, 范围 10~65535, 建议设置为平均在线人数的 10 倍左右</td>
	</tr>
	<tr><td class="item_title" colspan="2">搜索时间限制</td></tr>
	<tr>
		<td class="vtop rowform">
			 <cc1:TextBox SetFocusButtonID="SaveInfo" ID="searchctrl" runat="server" RequiredFieldType="数据校验" CanBeNull="必填" Text="0" MaxLength="5" Size="6"></cc1:TextBox>(单位:秒)		</td>
	...
	<tr>
		...
		<td class="vtop">注册页面提交表单中用户名的字符设置，默认是"username"，改变后可以有效防止注册机，例如"user1name"，不填为默认</td>
	</tr>	
	...
	<tr>
		...
		<td class="vtop">注册页面提交表单中Email的字符设置，默认是"email"，改变后可以有效防止注册机，请勿与用户名设置重复，不填为默认</td>
	</tr>	
	...
	<tr>
		...
		<td class="vtop">发帖页面提交表单中标题的字符设置，默认是"title"，改变后可以有效防止灌水机，例如"t1tle"，不填为默认</td>
	</tr>	
	...
	<tr>
		...
		<td class="vtop">发帖页面提交表单中标题的字符设置，默认是"message"，改变后可以有效防止灌水机，例如"mes5age"，请勿与标题设置重复，不填为默认</td>
	</tr>
