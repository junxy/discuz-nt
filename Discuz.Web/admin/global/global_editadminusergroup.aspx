<%@ Page Language="c#" Inherits="Discuz.Web.Admin.editadminusergroup" EnableViewState="true" Codebehind="global_editadminusergroup.aspx.cs" %>
...
<table width="100%">
	...
	<tr>
		<td class="vtop rowform">
			 <a href="#" class="TextButton" onclick="javascript:window.location.href='global_allowparticipatescore.aspx?pagename=global_editadminusergroup&groupid=<%=Request.Params["groupid"]%>'">
编辑评分范围</a>
		</td>
		<td class="vtop"></td>
	</tr>
