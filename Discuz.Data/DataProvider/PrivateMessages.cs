...
namespace Discuz.Data
{
    public class PrivateMessages
    {
        ...
        /// <returns></returns>
        public static string GetDeletePrivateMessagesCondition(bool isNew, string postDateTime, string msgFromList, bool lowerUpper, string subject,
            string message, bool isUpdateUserNewPm)
        {
            return DatabaseProvider.GetInstance().DeletePrivateMessages(isNew, postDateTime, msgFromList, lowerUpper,
                subject, message, isUpdateUserNewPm);
        }
